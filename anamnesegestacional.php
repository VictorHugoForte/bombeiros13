<?php
 ...
 $comando = $pdo->prepare("INSERT INTO anamnesegestacional VALUES('$gestacao',$prenatal,'$nomedomedico',$pre,$filho,'$quantos','$iniciouhoras',$duracao,'$intervalo',$pressao,$bolsa,$visual,$partorealizado,$sexodobebe,'$hrbebe','$nomebebe')" );
